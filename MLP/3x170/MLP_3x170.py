...
# def build_real_imag_model(input_shape, output_shape, l2_reg=1.3958194407488574e-05, dropout_rate=0.030599986124570044, leaky_relu_alpha=0.021321277210245057):
#     """
...
#     model.compile(
#         optimizer=tf.keras.optimizers.Adam(learning_rate=0.0030272832795760858),
#         loss=log_ae_loss,
#         metrics=['mse', 'mae']
#     )
