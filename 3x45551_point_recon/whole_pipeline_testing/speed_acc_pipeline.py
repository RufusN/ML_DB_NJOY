#python speed_acc_pipeline_temp.py --mode speed --batch 20000000 --chunk 1000000 --tmin 1000.0 --tmax 1000.0 --precision float32
#!/usr/bin/env python3
"""
...
def main():
    ...
    global fs
    eidxs = tf.random.uniform([args.batch], fs-100, fs-PAD, tf.int32)
    ...
    print(f"{args.batch:,} points → {dt:.2f} µs/point ({1e6/dt} lookups/s)")
