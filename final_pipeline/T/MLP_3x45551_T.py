...
def load_data_from_h5(directory):
    ...
    test_Ts = []
    test_Ts = [951.0,975.0,1000.0,1025.0,1049.0]
...
def main():
    ...
    # 1. Load data
    # -----------------------
    data_directory = '/mnt/d/new_specs_3_45551'
    ...
    for new_T in test_Ts:
        ...
        # -----------------------
        output_filename = f"./ML_predictions/predicted_spectrogram_{new_T}_real_imag.h5"
